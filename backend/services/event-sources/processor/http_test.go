...
// observed.
func newTestHttpSource(t *testing.T) (*HttpEventSource, *capturedDecode, *capturedFailure) {
	t.Helper()
	dec := &capturedDecode{}
...
func TestHttpEventSource_DecodeSuccess(t *testing.T) {
	es, dec, fail := newTestHttpSource(t)
