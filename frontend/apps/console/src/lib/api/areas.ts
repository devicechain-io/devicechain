...
// updateArea is a PARTIAL update: pass only the fields being changed. An omitted
// field is left alone, an explicit null clears it.
//
// 🔴 Callers must NOT carry forward the fields they do not edit. The `areaPreserved`
...
export const updateAreaGroup = (token: string, request: EntityGroupUpdateRequest) =>
