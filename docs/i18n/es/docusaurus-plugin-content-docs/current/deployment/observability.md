...
- Solo ve un flujo que el pod ha leído al menos una vez. Un pod que no ha podido leer un flujo
  desde que arrancó, incluido uno reiniciado después de que empezara el problema, no lo activa.
