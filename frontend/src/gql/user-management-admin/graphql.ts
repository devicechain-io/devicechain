...
export type TenantsQuery = { tenants: Array<{ id: string, token: string, name: string | null, enabled: boolean, config: string | null, createdAt: string | null, updatedAt: string | null }> };
...
export type CreateTenantMutation = { createTenant: { id: string, token: string, name: string | null, enabled: boolean, config: string | null, createdAt: string | null, updatedAt: string | null } };
...
export type UpdateTenantMutation = { updateTenant: { id: string, token: string, name: string | null, enabled: boolean, config: string | null, createdAt: string | null, updatedAt: string | null } };
...
export type SetTenantEnabledMutation = { setTenantEnabled: { id: string, token: string, name: string | null, enabled: boolean, config: string | null, createdAt: string | null, updatedAt: string | null } };
