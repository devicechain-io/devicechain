...
// obtained. Nil-safe.
func (m *detectMetrics) recordFenceGeometryUnresolved(n int) {
	if m == nil || n <= 0 {
		return
	}
...
func (m *detectMetrics) recordFenceGeometryHashMismatch() {
	if m == nil {
		return
	}
...
func (m *detectMetrics) recordFenceArchiveSkew() {
	if m == nil {
		return
	}
...
// occupancy. Nil-safe.
func (m *detectMetrics) recordFenceGeometryCache(hits, misses, evictions int, vertices int64) {
	if m == nil {
		return
	}
	if hits > 0 {
