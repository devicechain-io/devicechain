...
| `command_overflow_blocked_total` | Veces que el adaptador dejó de leer comandos porque no podía apartarlos lo bastante rápido. Solo sube mientras command-delivery está lento o inalcanzable, y entonces todos los comandos LwM2M esperan. |
