...
func startShutdownFixture(t *testing.T) (*shutdownProbe, string) {
	...
	prevPersist, prevRecon, prevSweep := EventPersistenceProcessor, EntityAnchorReconciler, AnchorSweep
	t.Cleanup(func() {
		Microservice, GraphQLManager, NatsManager, RdbManager = prevMs, prevGql, prevNats, prevRdb
		EventPersistenceProcessor, EntityAnchorReconciler, AnchorSweep = prevPersist, prevRecon, prevSweep
	})
