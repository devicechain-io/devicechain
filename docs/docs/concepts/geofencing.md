...
## Boundary rules {#what-a-boundary-may-be}
...
### Saving when you are over a limit {#saving-when-you-are-over-a-limit}
...
### Rings must bound an area {#rings-must-bound-an-area}
...
## Spherical containment {#the-maths-is-spherical}
...
## Fence-set versions and history {#fences-change}
...
### Unknown or missing fences {#unknown-fence}
...
### Fence sets in memory {#fence-set-retention}
