...
| **device-state** | La proyección en vivo del último estado conocido por dispositivo — presencia, ubicación más reciente, y lectura actual por medición. |
