...
- **Operator + CRDs** — a Kubernetes operator with a declarative `Instance` resource, not shell scripts; tenants are control-plane database records managed through the admin console.
