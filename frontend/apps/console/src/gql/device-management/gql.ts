...
const documents: Documents = {
    ...
    "\n  query AssetTypeVersions($token: String!) {\n    assetTypeVersions(token: $token) {\n      version\n      label\n      description\n      publishedAt\n      publishedBy\n      propertySchema\n    }\n  }\n": types.AssetTypeVersionsDocument,
    "\n  query ActiveAssetTypeVersion($token: String!) {\n    activeAssetTypeVersion(token: $token) {\n      version\n      label\n      publishedAt\n      propertySchema\n    }\n  }\n": types.ActiveAssetTypeVersionDocument,
    "\n  mutation PublishAssetType($token: String!, $label: String, $description: String) {\n    publishAssetType(token: $token, label: $label, description: $description) {\n      version\n    }\n  }\n": types.PublishAssetTypeDocument,
    "\n  mutation RollbackAssetType($token: String!, $version: Int!) {\n    rollbackAssetType(token: $token, version: $version) {\n      token\n      activeVersion\n    }\n  }\n": types.RollbackAssetTypeDocument,
    ...
    "\n  query DeviceGroupTargets {\n    entityGroups(criteria: { pageNumber: 1, pageSize: 500, memberType: \"device\" }) {\n      results {\n        token\n        name\n        membershipMode\n        activeVersion\n      }\n    }\n  }\n": types.DeviceGroupTargetsDocument,
    ...
    "\n  mutation RenameDeviceProfile($token: String!, $newToken: String!) {\n    renameDeviceProfile(token: $token, newToken: $newToken) {\n      id\n      token\n    }\n  }\n": types.RenameDeviceProfileDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query AssetTypeVersions($token: String!) {\n    assetTypeVersions(token: $token) {\n      version\n      label\n      description\n      publishedAt\n      publishedBy\n      propertySchema\n    }\n  }\n"): typeof import('./graphql').AssetTypeVersionsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query ActiveAssetTypeVersion($token: String!) {\n    activeAssetTypeVersion(token: $token) {\n      version\n      label\n      publishedAt\n      propertySchema\n    }\n  }\n"): typeof import('./graphql').ActiveAssetTypeVersionDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation PublishAssetType($token: String!, $label: String, $description: String) {\n    publishAssetType(token: $token, label: $label, description: $description) {\n      version\n    }\n  }\n"): typeof import('./graphql').PublishAssetTypeDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation RollbackAssetType($token: String!, $version: Int!) {\n    rollbackAssetType(token: $token, version: $version) {\n      token\n      activeVersion\n    }\n  }\n"): typeof import('./graphql').RollbackAssetTypeDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation CreateDevices($request: DeviceBulkCreateRequest!) {\n    createDevices(request: $request) {\n      id\n      token\n      name\n    }\n  }\n"): typeof import('./graphql').CreateDevicesDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query DeviceGroupTargets {\n    entityGroups(criteria: { pageNumber: 1, pageSize: 500, memberType: \"device\" }) {\n      results {\n        token\n        name\n        membershipMode\n        activeVersion\n      }\n    }\n  }\n"): typeof import('./graphql').DeviceGroupTargetsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation RenameDeviceProfile($token: String!, $newToken: String!) {\n    renameDeviceProfile(token: $token, newToken: $newToken) {\n      id\n      token\n    }\n  }\n"): typeof import('./graphql').RenameDeviceProfileDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
