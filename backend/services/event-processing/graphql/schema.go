...
// SchemaResolver is the GraphQL root resolver. It is intentionally state-free for
// the scaffold; later slices add the rule-CRUD surface and its rdb/api providers.
