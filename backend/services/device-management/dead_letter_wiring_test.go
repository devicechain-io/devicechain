...
func TestADeadLetterLandsOnThePlatformStreamWithThisServiceAsSource(t *testing.T) {
	...
	Microservice = &core.Microservice{InstanceId: instance, FunctionalArea: "device-management"}
	...
	require.Equal(t, "device-management", letter.Source, "the letter does not name this service as its source")
